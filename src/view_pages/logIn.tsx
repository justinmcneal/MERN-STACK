  ...
  const handleSignIn = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    setTimeout(() => {
      ...
      if (email === DEMO_EMAIL && password === DEMO_PASSWORD) {
        navigate("/dashboard"); // redirect if login success
      } else {
      ...
      <div className="relative z-10 min-h-screen grid grid-cols-1 lg:grid-cols-2">
        ...
        <div className="flex flex-col justify-center p-8 lg:p-16">
          <div className="max-w-md mx-auto w-full">
            ...
            {/* Demo Credentials */}
            <div className="mt-8 p-4 bg-slate-800/40 border border-slate-700/50 rounded-xl text-sm">
              <p className="text-slate-400 mb-2">Demo Login:</p>
              <p><span className="text-cyan-400">Email:</span> admin@gmail.com</p>
              <p><span className="text-cyan-400">Password:</span> password123</p>
            </div>
