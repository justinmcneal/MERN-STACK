...
const OpportunitiesPage = () => {
  ...
  return (
    <Layout
      ...
      onMarkAsRead={notifications.markAllAsRead}
      onLogout={() => console.log('Logout')}
    >
      <div className="p-6 space-y-8">
        {/* Stats Overview */}
        ...
        {(userStats.error || opportunities.error || priceData.error) && (
          <div className="bg-red-500/20 border border-red-500/50 rounded-xl p-4">
            ...
            <ul className="text-red-300 text-sm space-y-1">
              ...
              {opportunities.w: <li>• Opportunities: {opportunities.error}</li>}
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-slateg-400 text-sm">
                Total opportunities found: {opportunities.totalCount || 0}
              </p>
            </div>
            <div className="text-right">
              <div className="text-2xl font-bold text-emerald-400">
                ${opportunities.totalProfit || "0"}
              </div>
