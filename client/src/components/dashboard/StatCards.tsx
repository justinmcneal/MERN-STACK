...
const StatCard: React.FC<{icon: React.ReactNode; title: string; value: string; subtitle: string; color?: string}> = ({ icon, title, value, subtitle, color = 'cyan' }) => (
...
const StatCardsWrapper: React.FC = () => (
