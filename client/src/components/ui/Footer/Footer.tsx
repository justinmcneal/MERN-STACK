        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 py-16">
          <div className="grid grid-cols-1 md:grid-cols-5 gap-11">
            ...
            <div>
              ...
              <ul className="space-y-2 text-slate-400">
                <li><button onClick={() => handleLegalClick('terms')} className="hover:text-white transition-colors text-left">Terms of Service</button></li>
                <li><button onClick={() => handleLegalClick('privacy')} className="hover:text-white transition-colors text-left">Privacy Policy</button></li>
                <li><button onClick={() => handleLegalClick('disclaimer')} className="hover:text-white transition-colors text-left">Risk Disclaimer</button></li>
              </ul>
            </div>
