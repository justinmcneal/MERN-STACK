import { BarChart3, Zap, User, HelpCircle, Settings, Mail, Info } from "lucide-react";
...
const ContactSupportSidebar = ({ 
  ...
  const navigation = [
    ...
    { name: "Contact Support", icon: <Mail className="w-5 h-5 text-white" /> },
