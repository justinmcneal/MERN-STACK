// components/sections/ProfileSidebar.tsx
  ...
  return (
    <div
      className={`${sidebarOpen ? "translate-x-0" : "-translate-x-full"} 
                  ...
                  transition-transform duration-300 ease-in-out lg:translate-x-0 lg:static lg:inset-auto lg:transform-none ${className}`}
    >
